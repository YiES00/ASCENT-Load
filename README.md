...
The suite has 1,059 tests and takes about 12 minutes on the reference
...
|---|---|---|
| `pip install -e ".[dev,plot]"` | 1009 | **983 passed, 26 skipped** |
| `pip install -e ".[dev,plot,gui]"` | 1059 | **1033 passed, 26 skipped** |
