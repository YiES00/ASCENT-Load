...
The suite has 1,061 tests and takes about 14 minutes on the reference
...
|---|---|---|
| `pip install -e ".[dev,plot]"` | 1011 | **985 passed, 26 skipped** |
| `pip install -e ".[dev,plot,gui]"` | 1061 | **1035 passed, 26 skipped** |
